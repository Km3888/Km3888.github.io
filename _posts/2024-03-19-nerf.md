...
![dreamfusion](/images/nerf_images/dreamfusion.mp4)
...
Okay last piece of the puzzle: You have a 3D scene which is represented (perhaps very poorly) by a neural network and you are capable of rendering its scene representation into image space. So now how do you derive a tractable and differentiable loss function which will allow you to optimize your network parameters, leading it to *correctly* represent the 3D scene?
